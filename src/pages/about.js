  ...
  <Layout>
     <div className="Hero">
      <div className="HeroGroup">
        ...
        <p>Midorichan is my nickname. I was named Midori「緑、みどり」by my japanese grandparents, meaning: green, as in the first tiny leaf you see when a plant is growing. Over the years it has become part of my identity and my heritage.</p>
        <div className="Avatar">
          <img src={require('../images/paula-sepia.png')} width="300" alt="Paula"/>
        </div>
