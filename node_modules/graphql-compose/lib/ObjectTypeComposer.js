...
function isComposeOutputType(type) {
  return (0, _graphql.isType)(type) || Array.isArray(type) && isComposeOutputType(type[0]) || type instanceof _Resolver.Resolver || type instanceof ObjectTypeComposer || type instanceof _InterfaceTypeComposer.InterfaceTypeComposer || type instanceof _EnumTypeComposer.EnumTypeComposer || type instanceof _UnionTypeComposer.UnionTypeComposer || type instanceof _ScalarTypeComposer.ScalarTypeComposer;
} // Compose Args -----------------------------
...
class ObjectTypeComposer {
  ...
  getFieldExtensions(fieldName) {
    ...
    if ((0, _is.isObject)(field) && !(0, _is.isFunction)(field) && !Array.isArray(field) && !isComposeOutputType(field)) {
